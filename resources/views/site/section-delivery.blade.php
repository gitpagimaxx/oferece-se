	...
	<div class="container-fluid text-bg-light bg-hydrogen">
		<div class="container pt-4 pb-4">
            <div class="row">
                ...
                <a href="https://wa.me/55{{$perfil[0]->WhatsApp}}?text=Estou%20interessado%20em%20seus%20produtos" class="btn btn-success btn-lg border border-info-subtle pt-4 pb-4" target="_blank">Me chame no WhatsApp &nbsp;<i class="fab fa-whatsapp"></i></a>
                </p>
            </div>
        </div>
	</div>
